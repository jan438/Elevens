...
cardposition[0] = [-100, -150];
cardposition[1] = [0, -150];
cardposition[2] = [100, -150];
cardposition[3] = [-150, 0];
cardposition[4] = [-50, 0];
cardposition[5] = [50, 0];
cardposition[6] = [150, 0];
cardposition[7] = [-100, 150];
cardposition[8] = [0, 150];
cardposition[9] = [100, 150];
var deckcards = [];
var tableaucards = [[],[],[],[],[],[],[],[],[],[]];
var selectedcards = [];
var cardxpos;
			...
			for (var i = 0; i < selectedcards.length; i++) {
				for (var j = 0; j < counttableaucards; j++) {
					if (selectedcards[i].x === cardposition[j][0] && selectedcards[i].y === cardposition[j][1]) {
						...
						var achievedcount = tableaucards[0].length + tableaucards[1].length + tableaucards[2].length +
						tableaucards[3].length + tableaucards[4].length + tableaucards[5].length + tableaucards[6].length +
						tableaucards[7].length + tableaucards[8].length + tableaucards[9].length;
